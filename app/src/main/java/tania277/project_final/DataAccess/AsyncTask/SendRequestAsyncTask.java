...
/**
 * Created by Srinidhi on 11/20/2015.
 */
public class SendRequestAsyncTask extends AsyncTask<Object, Void, Boolean> {
    ...
    protected Boolean doInBackground(Object... params) {
        ...
        try {
            ...
            Log.i("message:","Put data is "+qb.sendRequest(user));
